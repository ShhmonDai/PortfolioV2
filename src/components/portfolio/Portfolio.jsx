...
const dataFeatured = [
  {
    ...
    description3: 'Goals, Subgoals and Habits within 3 self improvement categories; Mind, Body, Spirit.',
    description4: 'Streak tracking of completed Habits and a daily Habits timeline.',
    description5: 'Wallpaper Engine integration - Dashboard as a Live Interactable Desktop Wallpaper.',
    description6: 'Informative Dashboard and artistic, custom designed UI/UX.',
